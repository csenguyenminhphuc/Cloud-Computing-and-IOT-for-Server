 ...
 ******************************************************************************/
    ...
    adminAuth: {
       ...
       users: [{
           username: "admin",
           password: "$2b$08$.kwXq4LvTakTjCGCtKe4kuXX9kKw5DCeTUv1kuXlQtWqHBxd9JWNK",
           permissions: "*"
       }]
    },
    ...
    https: function() {
        ...
        return {
            key: require("fs").readFileSync('C:/Users/Administrator/.node-red/node-red.key'),
            cert: require("fs").readFileSync('C:/Users/Administrator/.node-red/node-red.cert')
        }
    },
     ...
     */
    httpNodeAuth: {user:"admin",pass:"$2b$08$.kwXq4LvTakTjCGCtKe4kuXX9kKw5DCeTUv1kuXlQtWqHBxd9JWNK"},
